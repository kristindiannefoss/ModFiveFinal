...
describe('the scoreWord function must strip whitespace', function () {
  ...
  it('can score hello with post-spaces', function () {
    const score = scoreWord('hello ');
    assert.equal(8 , score);
  });

  it('can score hello with pre-spaces', function () {
    const score = scoreWord(' hello');
    assert.equal(8 , score);
  });
...
describe('the scoreWord function can multiply', function () {
  it('can score with double word score', function () {
